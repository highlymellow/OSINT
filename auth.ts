...
export const DEMO_ACCOUNTS: Record<string, { password: string; user: MeridianUser }> = {
  "admin@meridian.iq": {
    password: (import.meta as any).env.VITE_ADMIN_PASSWORD || "ENCRYPTED_ADMIN_KEY",
    user: {
      id: "usr_001",
      name: "Mohammed Anwer",
  ...
  "analyst@meridian.iq": {
    password: (import.meta as any).env.VITE_ANALYST_PASSWORD || "ENCRYPTED_ANALYST_KEY",
    user: {
      id: "usr_002",
      name: "Sara Al-Rashid",
  ...
  "observer@meridian.iq": {
    password: (import.meta as any).env.VITE_OBSERVER_PASSWORD || "ENCRYPTED_OBSERVER_KEY",
    user: {
      id: "usr_003",
      name: "James Chen",
  ...
  "press@meridian.iq": {
    password: (import.meta as any).env.VITE_PRESS_PASSWORD || "ENCRYPTED_PRESS_KEY",
    user: {
      id: "usr_004",
