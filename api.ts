...
// When NEXT_PUBLIC_API_URL is set → fetches from FastAPI
// When not set → falls back to simulated data in data.ts
// This allows frontend to work identically with real or mock data.
// ═══════════════════════════════════════════════════════════════════
...
const IS_LIVE = !!API_BASE && process.env.NEXT_PUBLIC_MERIDIAN_LIVE === "true";
